...
import 'reproductive_status_controller.dart';

class ReproductiveStatusScreen extends StatelessWidget {
  final ReproductiveStatusController controller = Get.put(
    ReproductiveStatusController(),
  );

  ReproductiveStatusScreen({super.key});
                  ...
                  child: Obx(
                    () => Column(
                      children: controller.options.map((option) {
                        bool isSelected =
                            controller.selectedStatus.value == option["title"];
                        return GestureDetector(
                          onTap: () =>
                              controller.selectStatus(option["title"]!),
                          child: Container(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              shape: RoundedRectangleBorder(
                                ...
                                side: const BorderSide(
                                  color: Colors.white,
                                ), // Invisible or light border? Image shows white bg, keeping clean
                              ),
                              elevation: 0,
                            ),
                            child: Text(
