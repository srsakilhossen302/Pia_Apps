...
import 'cycle_length_controller.dart';

class CycleLengthScreen extends StatelessWidget {
  final CycleLengthController controller = Get.put(CycleLengthController());

  CycleLengthScreen({super.key});
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    // Completed Steps (1, 2, 3) - Filled Pink
                    Expanded(
                      flex: 3,
                      child: Container(
                        height: 4.h,
              ...
              Container(
                ...
                child: Center(
                  child: Image.asset(
                    AppIcons.periodLength, // New icon for cycle length
                    width: 40.w,
                    height: 40.h,
                    color: const Color(0xFFF09AB1),
                  ),
